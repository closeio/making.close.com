...
reasons, but one of the top ones is our [built-in
calling](https://close.com/calling/). However, over the last few months we'd
sporadically receive concerning bug reports about this feature:
